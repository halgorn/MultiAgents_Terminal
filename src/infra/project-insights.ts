...
export function renderInsightsMarkdown(insights: ProjectInsights): string {
  ...
  lines.push(`- Query test signals: ${insights.database.queryTestSignals}`);
  ...
  lines.push(`- Large asset files: ${insights.performance.largeAssetFiles}`);
