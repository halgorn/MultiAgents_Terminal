...
| Planner repo context | Done | Planner receives deterministic repo-index context when available. |
| Evidence gate | Done | Audit findings are filtered against repo-index file/line facts when available. |
...
4. Add dedicated Graph Agent and Tests Agent wrappers around `.ai-runtime/repo-index.json`.
